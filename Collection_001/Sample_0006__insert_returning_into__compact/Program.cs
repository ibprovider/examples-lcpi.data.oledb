...
namespace Sample_0006__compact
{
 class Program
 {
  ...
  static int Main(string[] args)
  {
   ...
   try
   {
    const string c_test_str=".NET Provider Sample #0006c";
    ...
    cmd["x"].Value=c_test_str;

    var RowsAffected=cmd.ExecuteNonQuery();

    var rec_id=cmd["record_id"].Value;
