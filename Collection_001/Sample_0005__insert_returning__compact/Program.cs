...
namespace Sample_0005__compact
{
 class Program
 {
  ...
  static int Main(string[] args)
  {
   ...
   try
   {
    const string c_test_str=".NET Provider Sample #0005c";
